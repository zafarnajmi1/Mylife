...
class NotificationReadModel : NSObject, NSCoding{

	var data : [AnyObject]!
	var message : String!
	var pagination : NotificationReadPagination!
	var statusCode : Int!
	...
	init(fromDictionary dictionary: [String:Any]){
		...
		if let paginationData = dictionary["pagination"] as? [String:Any]{
			pagination = NotificationReadPagination(fromDictionary: paginationData)
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         pagination = aDecoder.decodeObject(forKey: "pagination") as? NotificationReadPagination
