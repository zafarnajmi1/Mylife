//
//	DeleteEducationInformationModel.swift
//
...
class DeleteEducationInformationModel : NSObject, NSCoding{

	var data : [AnyObject]!
	var message : String!
	var pagination : DeleteEducationInformationPagination!
	var statusCode : Int!
	...
	init(fromDictionary dictionary: [String:Any]){
		...
		if let paginationData = dictionary["pagination"] as? [String:Any]{
			pagination = DeleteEducationInformationPagination(fromDictionary: paginationData)
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         pagination = aDecoder.decodeObject(forKey: "pagination") as? DeleteEducationInformationPagination
