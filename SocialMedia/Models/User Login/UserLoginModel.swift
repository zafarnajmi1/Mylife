...
class UserLoginModel : NSObject, NSCoding{
	...
	var message : String!
	var pagination : UserLoginPagination!
	var statusCode : Int!
	...
	init(fromDictionary dictionary: [String:Any]){
		if let dataData = dictionary["data"] as? [String:Any]{
			data = UserLoginData(fromDictionary: dataData)
		}
		message = dictionary["message"] as? String
		if let paginationData = dictionary["pagination"] as? [String:Any]{
			pagination = UserLoginPagination(fromDictionary: paginationData)
		}
    ...
    */
	...
	{
         data = aDecoder.decodeObject(forKey: "data") as? UserLoginData
         message = aDecoder.decodeObject(forKey: "message") as? String
         pagination = aDecoder.decodeObject(forKey: "pagination") as? UserLoginPagination
