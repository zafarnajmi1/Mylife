...
class PostDetailsData : NSObject, NSCoding{

	var checkinPlace : String!
	var createdAt : Int!
	var descriptionField : String!
	var feeling : PostDetailsFeeling!
	var feelingId : Int!
	var id : Int!
	var latitude : String!
	...
	var myLikeCount : Int!
	var parentId : Int!
    var postAttachment : PostDetailsPostAttachment!
    var postAttachmentData : [PostDetailsPostAttachment]!
	var postType : String!
	var scheduleAt : Int!
	var sharingType : String!
	var tagFriends : [PostDetailsTagFriend]!
	var totalComments : Int!
	var totalLikes : Int!
	var totalShares : Int!
	var updatedAt : Int!
	var user : PostDetailsUser!
	var userId : Int!
	...
	init(fromDictionary dictionary: [String:Any]){
		...
		if let feelingData = dictionary["feeling"] as? [String:Any]{
			feeling = PostDetailsFeeling(fromDictionary: feelingData)
		}
...
//            postAttachment = PostDetailsPostAttachment(fromDictionary: postAttachmentData)
//        }
        if let _postAttachmentData = dictionary["post_attachment"] as? NSArray{
//            postAttachment = PostDetailsPostAttachment(fromDictionary: _postAttachmentData)
            postAttachmentData = []
            for value in _postAttachmentData {
                let dictionary = value as? NSDictionary
                let data  : PostDetailsPostAttachment = PostDetailsPostAttachment(fromDictionary: dictionary! as! [String : Any])
		...
		if let userData = dictionary["user"] as? [String:Any]{
			user = PostDetailsUser(fromDictionary: userData)
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         feeling = aDecoder.decodeObject(forKey: "feeling") as? PostDetailsFeeling
         ...
         postAttachment = aDecoder.decodeObject(forKey: "post_attachment") as? PostDetailsPostAttachment
         ...
         tagFriends = aDecoder.decodeObject(forKey :"tag_friends") as? [PostDetailsTagFriend]
         ...
         user = aDecoder.decodeObject(forKey: "user") as? PostDetailsUser
