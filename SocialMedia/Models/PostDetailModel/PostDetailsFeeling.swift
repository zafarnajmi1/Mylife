//
//	PostDetailsFeeling.swift
//	Model file generated using JSONExport: https://github.com/Ahmed-Ali/JSONExport

import Foundation


class PostDetailsFeeling : NSObject, NSCoding{

	var createdAt : Int!
	var emoji : String!
	var id : Int!
	var translation : PostDetailsTranslation!
	var updatedAt : Int!
	...
	init(fromDictionary dictionary: [String:Any]){
		...
		if let translationData = dictionary["translation"] as? [String:Any]{
			translation = PostDetailsTranslation(fromDictionary: translationData)
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         translation = aDecoder.decodeObject(forKey: "translation") as? PostDetailsTranslation
