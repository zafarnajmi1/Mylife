//
//	DeleteWorkInformationModel.swift
//
...
class DeleteWorkInformationModel : NSObject, NSCoding{

	var data : [AnyObject]!
	var message : String!
	var pagination : DeleteWorkInformationPagination!
	var statusCode : Int!
	...
	init(fromDictionary dictionary: [String:Any]){
		...
		if let paginationData = dictionary["pagination"] as? [String:Any]{
			pagination = DeleteWorkInformationPagination(fromDictionary: paginationData)
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         pagination = aDecoder.decodeObject(forKey: "pagination") as? DeleteWorkInformationPagination
