//
//	Follow-UnFollowUsersModel.swift
//
...
class FollowUnFollowUsersModel : NSObject, NSCoding {

	var data : [AnyObject]!
	var message : String!
	var pagination : FollowUnFollowUsersPagination!
	var statusCode : Int!
	...
	init(fromDictionary dictionary: [String:Any]){
		...
		if let paginationData = dictionary["pagination"] as? [String:Any]{
			pagination = FollowUnFollowUsersPagination(fromDictionary: paginationData)
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         pagination = aDecoder.decodeObject(forKey: "pagination") as? FollowUnFollowUsersPagination
