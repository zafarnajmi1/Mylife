...
class UserPhotoesModel : NSObject, NSCoding{
	...
	var message : String!
	var pagination : UserPhotoesPagination!
	var statusCode : Int!
	...
	init(fromDictionary dictionary: [String:Any]){
		...
		if let paginationData = dictionary["pagination"] as? [String:Any]{
			pagination = UserPhotoesPagination(fromDictionary: paginationData)
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         pagination = aDecoder.decodeObject(forKey: "pagination") as? UserPhotoesPagination
