//
//	RejectFriendRequestModel.swift
//
...
class RejectFriendRequestModel : NSObject, NSCoding{

	var data : [AnyObject]!
	var message : String!
	var pagination : RejectFriendRequestPagination!
	var statusCode : Int!
	...
	init(fromDictionary dictionary: [String:Any]){
		...
		if let paginationData = dictionary["pagination"] as? [String:Any]{
			pagination = RejectFriendRequestPagination(fromDictionary: paginationData)
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         pagination = aDecoder.decodeObject(forKey: "pagination") as? RejectFriendRequestPagination
