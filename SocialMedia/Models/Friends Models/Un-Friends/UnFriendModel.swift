...
class UnFriendModel : NSObject, NSCoding{

	var data : [AnyObject]!
	var message : String!
	var pagination : UnFriendPagination!
	var statusCode : Int!
	...
	init(fromDictionary dictionary: [String:Any]){
		...
		if let paginationData = dictionary["pagination"] as? [String:Any]{
			pagination = UnFriendPagination(fromDictionary: paginationData)
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         pagination = aDecoder.decodeObject(forKey: "pagination") as? UnFriendPagination
