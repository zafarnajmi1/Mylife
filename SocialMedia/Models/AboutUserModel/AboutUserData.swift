...
struct AboutUserData{
    ...
    var cover : String!
    var createdAt : Int!
    var educationDetails : [AboutUserEducationDetail]!
    var email : String!
    var fullName : String!
    var gender : String!
    var id : Int!
    ...
    var updatedAt : Int!
    var workDetails : [AboutUserWorkDetail]!
