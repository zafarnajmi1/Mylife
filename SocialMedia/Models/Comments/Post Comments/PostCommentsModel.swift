...
class PostCommentsModel : NSObject, NSCoding{

	var data : GetCommentsData!
	var message : String!
	var pagination : PostCommentsPagination!
	var statusCode : Int!
	...
	init(fromDictionary dictionary: [String:Any]){
		if let dataData = dictionary["data"] as? [String:Any]{
			data = GetCommentsData(fromDictionary: dataData)
		}
		message = dictionary["message"] as? String
		if let paginationData = dictionary["pagination"] as? [String:Any]{
			pagination = PostCommentsPagination(fromDictionary: paginationData)
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         pagination = aDecoder.decodeObject(forKey: "pagination") as? PostCommentsPagination
