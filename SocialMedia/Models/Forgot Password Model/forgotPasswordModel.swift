...
//
//	Create by Apple PC on 31/10/2017
...
class forgotPasswordModel : NSObject, NSCoding{

	var data : [AnyObject]!
	var message : String!
	var pagination : forgotPasswordPagination!
	var statusCode : Int!
	...
	init(fromDictionary dictionary: [String:Any]){
		...
		if let paginationData = dictionary["pagination"] as? [String:Any]{
			pagination = forgotPasswordPagination(fromDictionary: paginationData)
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         pagination = aDecoder.decodeObject(forKey: "pagination") as? forgotPasswordPagination
