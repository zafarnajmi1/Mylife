...
public class Checkbox: UIControl {
    ...
    public var borderStyle: BorderStyle = .circle
    ...
    private func squareBorder(rect: CGRect) {
        ...
        rectanglePath.lineWidth = CGFloat(borderWidthPreset.rawValue)
    ...
    private func circleBorder(rect: CGRect) {
        ...
        let adjustedRect = CGRect(x: CGFloat(borderWidthPreset.rawValue)/2,
                                  y: CGFloat(borderWidthPreset.rawValue)/2,
                                  w: rect.width-CGFloat(borderWidthPreset.rawValue),
                                  h: rect.height-CGFloat(borderWidthPreset.rawValue))
        ...
        ovalPath.lineWidth = CGFloat(borderWidthPreset.rawValue) / 2
        ovalPath.stroke()
        checkboxBackgroundColor.setFill()
        ovalPath.fill()
    }
