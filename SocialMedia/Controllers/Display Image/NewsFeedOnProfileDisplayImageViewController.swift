//
//  NewsFeedOnProfileDisplayImageViewController.swift
//  SocialMedia
//
//  Created by Imran Jameel on 3/16/18.
...
class NewsFeedOnProfileDisplayImageViewController: UIViewController, NVActivityIndicatorViewable,UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        newsFeedImage.sd_setImage(with: URL(string: (objFeed?.postAttachmentData[0].path)!), placeholderImage: UIImage(named: "placeHolderGenral"))                  //need to uncomment this line  .postAttachment.path
    ...
    func goToComments (objFeed: TimelineData){
    ...
    func showActionSheetShare (postId: Int, index: Int){
        ...
        let shareTimeLine: UIAlertAction = UIAlertAction(title: "Share on my timeline", style: .default) { action -> Void in
            ...
            self.showShareConfirmationAlert(WithMsg: "Do you really want to shate this post on your timeline?".localized, Type : "private" ,PostId: postId, Index: index)
        }
