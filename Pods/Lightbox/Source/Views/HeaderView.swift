...
open class HeaderView: UIView {
  open fileprivate(set) lazy var closeButton: UIButton = { [unowned self] in
    let title = NSAttributedString(
      ...
      attributes: LightboxConfig.CloseButton.textAttributes as [NSAttributedString.Key : Any])
  ...
  open fileprivate(set) lazy var deleteButton: UIButton = { [unowned self] in
    let title = NSAttributedString(
      ...
      attributes: LightboxConfig.DeleteButton.textAttributes as [NSAttributedString.Key : Any])
